...
vec4 EM( )
{
    return texture(texture4,((outUV0)) );
}
...
void main( )
{
    ...
    outPosition      = viewProjMatrix * (worldMatrix * vec4( Position, 1.0));
    outWorldPosition = (vec4( Position, 1.0) * worldMatrix ).xyz;
    outNormal   = Normal   * mat3(worldMatrix);
    outUV0 = UV0;
