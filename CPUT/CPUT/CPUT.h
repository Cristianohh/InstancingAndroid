...
// You need to define explicitly usage of OpenGL only on Windows,
// as by default DirectX 11 is used. For other platforms graphic
// API will be set automaticly.

// TODO: In future, move API specific code to different namespaces
//       and choose required API by passing shadingLanguage parameter
//       to function that creates window, for e.g. :
//
//       .shadingLanguage = HLSL_4_0;
//       .shadingLanguage = GLSL_4_30;
//       .shadingLanguage = ESSL_3_0;
//

//Define these explicitly in build settings
// Also, why are these here? 

// Determine target platform
//#if defined( ANDROID )
//#define CPUT_OS_ANDROID
//#elif defined( __QNX__ )
//#define CPUT_OS_BLACKBERRY
//#elif defined( _WIN32 ) || defined( WIN32 ) || defined( __WIN32__ )
//#define CPUT_OS_WINDOWS
//#elif defined( TARGET_OS_IPHONE ) || defined( TARGET_IPHONE_SIMULATOR )
//#define CPUT_OS_IOS
//#elif defined( macintosh ) || defined( TARGET_OS_MAC ) || defined( __APPLE__ ) || defined( __APPLE_CC__ ) 
//#define CPUT_OS_MACOS
//#else
//#define CPUT_OS_LINUX
//#endif

// Determine target graphic API
//#if defined( CPUT_OS_ANDROID ) || defined( CPUT_OS_BLACKBERRY ) || defined( CPUT_OS_IOS )
//#define CPUT_FOR_OGLES
//#elif defined( CPUT_OS_MACOS ) || defined( CPUT_OS_LINUX )
//#define CPUT_FOR_OGL
...
#include <GLES3/gl3ext.h>             // OpenGL ES 3.0 Extensions 
#else
...
#define DEBUG_PRINT(s, ...) {TCHAR sOut[256]; swprintf_s(sOut, 256, s, __VA_ARGS__); OutputDebugString(sOut); OutputDebugString(L"\n");}
#define DEBUG_PRINTA(s, ...) {CHAR sOut[256]; sprintf_s(sOut, 256, s, __VA_ARGS__); OutputDebugStringA(sOut); OutputDebugString("\n");}
#else 
#define DEBUG_PRINT(...)
#endif
#endif
...
public:
    CPUT() :
        ...
        mLightColor(8.0f, 8.0f, 8.0f, 1.0f),
        mpBackBuffer(NULL),
        mpDepthBuffer(NULL),
