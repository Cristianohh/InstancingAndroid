...
namespace CPUTFileSystem
{
    ...
    CPUTResult ReadFileContents(const cString &fileName, UINT *psizeInBytes, void **ppData, bool bAddTerminator = false, bool bLoadAsBinary = false);
	CPUTResult ReadFileContentsA(const std::string &fileName, UINT *psizeInBytes, void **ppData, bool bAddTerminator = false, bool bLoadAsBinary = false);
